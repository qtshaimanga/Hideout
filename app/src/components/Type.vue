	...
	<div class="type">
		<div class="container">
			...
			<div class="controls">
				...
				<div class="save" @click="save">save my secret</div>
			</div>
		</div>
	</div>
</template>
...
.type{
	...
	.container{
		...
		.type-secret{
			...
			#svg_type {
				.cls-1{fill:url(#Dégradé_sans_nom_21);}
				.cls-2{fill:url(#Dégradé_sans_nom_21-2);}
				.cls-3{fill:url(#Dégradé_sans_nom_21-3);}
				.cls-4{fill:url(#Dégradé_sans_nom_21-4);}
				.cls-5{fill:url(#Dégradé_sans_nom_21-5);}
				.cls-6{fill:url(#Dégradé_sans_nom_21-49);}
				.cls-7{fill:url(#Dégradé_sans_nom_21-50);}
				.cls-8{fill:url(#Dégradé_sans_nom_21-89);}
			}
		}
		.controls{
			display: flex;
