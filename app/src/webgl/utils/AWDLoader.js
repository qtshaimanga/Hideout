...
import {
  DefaultLoadingManager, Object3D, Mesh, MeshPhongMaterial,
  ImageLoader, Texture, XHRLoader, Bone, Matrix4, BufferGeometry, BufferAttribute
} from 'three';

var UNCOMPRESSED = 0, DEFLATE = 1, LZMA = 2;

var AWD_FIELD_INT8 = 1, AWD_FIELD_INT16 = 2, AWD_FIELD_INT32 = 3;
var AWD_FIELD_UINT8 = 4, AWD_FIELD_UINT16 = 5, AWD_FIELD_UINT32 = 6;
var AWD_FIELD_FLOAT32 = 7, AWD_FIELD_FLOAT64 = 8;
var AWD_FIELD_BOOL = 21;
var AWD_FIELD_COLOR = 22;
var AWD_FIELD_BADDR = 23;
var AWD_FIELD_STRING = 31;
var AWD_FIELD_BYTEARRAY = 32;
var AWD_FIELD_VECTOR2x1 = 41, AWD_FIELD_VECTOR3x1 = 42, AWD_FIELD_VECTOR4x1 = 43;
var AWD_FIELD_MTX3x2 = 44, AWD_FIELD_MTX3x3 = 45, AWD_FIELD_MTX4x3 = 46, AWD_FIELD_MTX4x4 = 47;

var BOOL = 21, COLOR = 22, BADDR = 23;

var INT8 = 1, INT16 = 2, INT32 = 3;
var UINT8 = 4, UINT16 = 5, UINT32 = 6;
var FLOAT32 = 7, FLOAT64 = 8;
...
export class AWDLoader {
  ...
  _parseHeader() {
    ...
    this._geoNrType = this._accuracyGeo ?
      FLOAT64 :
      FLOAT32;
    this._matrixNrType = this._accuracyMatrix ?
      FLOAT64 :
      FLOAT32;
    this._propsNrType = this._accuracyProps ?
      FLOAT64 :
      FLOAT32;
  ...
  parseMeshPoseAnimation(len, poseOnly) {
    ...
    var num_frames = 1, num_submeshes, frames_parsed, subMeshParsed, frame_dur, x, y, z;
    var str_len, str_end, geom, subGeom, idx = 0, clip = {}, indices, verts, num_Streams, streamsParsed, streamtypes = [];
    var props, thisGeo, name = this.readUTF(), geoAdress = this.readU32();
