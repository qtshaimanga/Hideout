    ...
    THREE.FlyControls = function ( object, domElement, opts ) {
        ...
        this.mousemove = function( event ) {
            ...
            if ( !this.dragToLook || this.mouseStatus > 0 ) {
                ...
                //console.log("---");
                this.moveState.yawLeft = map(this.moveState.yawLeft, 0, 0.1, -0.1, 0);
        ...
        this.update = function( delta ) {
            ...
            //ADD : -detla*
            this.tmpQuaternion.set( this.rotationVector.x * 0.01, this.rotationVector.y * rotMult, this.rotationVector.z * 0.01, 1 ).normalize();
        ...
        this.updateRotationVector = function() {
            ...
            //console.log(this.moveState.pitchDown, this.moveState.pitchUp);

            // console.log( [ this.moveState.pitchDown, this.moveState.pitchUp ] );
            // console.log( [ this.moveState.yawRight, this.moveState.yawLeft ]);
            // console.log("---");

            this.rotationVector.x = ( -this.moveState.pitchDown + this.moveState.pitchUp );

            //this.rotationVector.x = 0.5;
            // console.log(this.moveState.yawLeft);
            //&& this.moveState.yawLeft < -0.23
            // if(this.moveState.yawLeft < 0.5 && this.moveState.yawLeft > -0.5 ){
